# Interpretation Agent Requirements
...
Process analysis requests and contextualize results based on user queries. Bridge the gap between raw perceptual outputs and actionable, user-relevant insights.
