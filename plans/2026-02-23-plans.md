...
|----------|-------|---------------|
| � Agent-Application separation (P1) | 6 | ~150 minutes |
...
1. **Batch A — Agent-Application separation** (1.1–1.6): Refactor all agent files to remove application-specific content. **START HERE.**
